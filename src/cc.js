...
(function(factory){
    ...
    CC.extend = function _extend(prop) {
        ...
        rp = createProto(sp, Class); //以父类原型作为原型,并使用子类的构造函数创建出一个对象
        Class._supper = createProto(sp, this); //创建出一个父类的实例,作为钩子
        Class.prototype = mixin(rp, Class.prototype);//合并Class上的基础方法
